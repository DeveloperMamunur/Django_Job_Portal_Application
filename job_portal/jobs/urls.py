...
urlpatterns = [
    ...
    path('post/approved/<int:application_id>/', views.approve_application, name='approve_application'),
    path('post/rejected/<int:application_id>/', views.reject_application, name='reject_application')
]